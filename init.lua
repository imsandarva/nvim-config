...
require('lazy').setup({
  ...
  -- Temporarily disable autocompletion to test basic LSP functionality
  -- {
  --   'hrsh7th/nvim-cmp',
  --   dependencies = {
  ...
  -- },
  {
    ...
    config = function()
      ...
      -- Configure capabilities (without nvim-cmp dependency for now)
      ...
      -- Test basic LSP functionality - just try to start pyright
  ...
  -- Python linting and type checking - Temporarily disabled
  -- {
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = {
        ...
        'query', 'vim', 'vimdoc', 'python', 'javascript', 'typescript', 'json', 'yaml'
      },
...
-- File switching with Space + n and Space + p
vim.keymap.set('n', '<Space>n', ':bnext<CR>', { noremap = true, silent = true }) -- Next buffer
vim.keymap.set('n', '<Space>b', ':bprevious<CR>', { noremap = true, silent = true }) -- Previous buffer

-- Quick save with Ctrl + S
vim.keymap.set('n', '<C-s>', ':w<CR>', { noremap = true, silent = true })

-- remove a word backward in insert mode.
vim.keymap.set('i', '<C-Left>', '<C-o>db', { noremap = true })

vim.api.nvim_set_keymap('i', '<C-CR>', '<Esc>o', { noremap = true, silent = true })

-- Remap Ctrl + A to select all in normal mode
vim.api.nvim_set_keymap('n', '<C-a>', 'ggVG', { noremap = true, silent = true })

-- Map Ctrl + H to move backward by one word in insert mode
vim.api.nvim_set_keymap('i', '<C-H>', '<C-o>b', { noremap = true, silent = true })

-- Map Ctrl + L to move forward by one word in insert mode
vim.api.nvim_set_keymap('i', '<C-L>', '<C-o>w', { noremap = true, silent = true })

-- Move cursor down one line in insert mode with Ctrl+Shift+Down
vim.keymap.set('i', '<C-S-Down>', '<Esc>jgi', { noremap = true, silent = true })

-- Move cursor up one line in insert mode with Ctrl+Shift+Up
vim.keymap.set('i', '<C-S-Up>', '<Esc>kgi', { noremap = true, silent = true })
...
-- Reliable Nvim-tree toggle on <C-b>
vim.keymap.set('n', '<C-b>', ':NvimTreeToggle<CR>', { desc = 'Toggle NvimTree', noremap = true, silent = true })
